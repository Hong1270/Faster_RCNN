    ...
    * :obj:`total_loss`: The sum of 4 loss above.
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        * :math:`R` is the number of bounding boxes per image.
        ...
        bbox = bboxes[0] # ground truth
        label = labels[0] # ground truth
        rpn_score = rpn_scores[0] # rpn score of anchor boxex
        rpn_loc = rpn_locs[0] # rpn offest of anchor boxex
        roi = rois # roi proposal based on rpn_score and rpn_loc
